...
int main(void) {
        ...
        printf("=> Test8: indexOf and lastIndexOf\n");
        {
        ...
        printf("=> Test10: out-of-index exception\n");
        {
                sb= StringBuffer_new("abc");
                assert(sb);
                TRY
